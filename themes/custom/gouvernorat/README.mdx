...
gouvernorat theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of gouvernorat theme and run the following commands:
`nvm use`
...
`drush en gouvernorat -y`
`drush config-set system.theme default gouvernorat -y`
